...
/// A metric the logical meter can stream, with its quantity type and the kind
/// of graph formula that computes it.
pub trait Metric:
...
mod tests {
    ...
    fn test_ac_power_apparent_metric() {
        ...
        assert_eq!(AcPowerApparent::FORMULA_KIND, FormulaKind::Aggregation);
